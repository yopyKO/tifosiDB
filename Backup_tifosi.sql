...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : jeu. 19 déc. 2024 à 15:31
...
ALTER TABLE `achete`
  ...
  ADD KEY `fk_focaccia1` (`id_focaccia`);
...
ALTER TABLE `constitue`
  ...
  ADD KEY `fk_focaccia3` (`id_focaccia`);
...
ALTER TABLE `contient`
  ...
  ADD KEY `fk_boisson1` (`id_boisson`);
